...
/*
int main(){
    EC2DPoint Point1 = EC2DPoint(0,0);
    EC2DPoint Point2 = EC2DPoint(4,0);
    EC2DPoint Point3 = EC2DPoint(2,2);
    //EC2DPoint Point4 = EC2DPoint(1,1);
    ...
    //ECLineSegment Line1 = ECLineSegment(Point1,Point2);
    //ECLineSegment Line2 = ECLineSegment(Point3,Point4);

    cout << Direction(Point1, Point2, Point3) << endl;
    cout << OnSegment(Point1, Point2, Point3) << endl;

    bool test = Line1.IsIntersect(Line2);
